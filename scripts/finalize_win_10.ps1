...
try {
    ...
    C:\Packer\Downloads\OSOT.exe -o all-item -t "Omnissa Templates\Windows 10, 11 and Server 2022, 2025" -SyncHkcuToHku Enable -VisualEffect Balanced -Notification Enable -WindowsSearch SearchBoxAsIcon -StoreApp Remove-All --exclude Calculator Paint3D Photos -OneDrive Disable -SmartScreen Disable -Background "#000000" -v
